...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .btn-nav:hover { background: var(--bg); color: var(--text); }
        ...
        .btn-nav-filled:hover { background: #333; }
        ...
        .btn-nav-accent:hover { background: #a83609; }
        ...
        .btn-accent-custom:hover { background: #a83609; color: #fff; }
        ...
        .btn-ghost-custom:hover { background: var(--surface); color: var(--text); }
        ...
        .post-card-author-name { font-size: 12px; color: var(--text-muted); }
        .post-card-title {
        ...
        .post-card-date { font-size: 11px; color: var(--text-faint); }
        .post-card-read { font-size: 12px; font-weight: 500; color: var(--accent); }
    </style>
</head>
<body>
